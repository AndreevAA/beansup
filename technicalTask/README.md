...
* [Восстановление пароля](#восстановлениепароля)
* [Первый вход](https://github.com/AndreevAA/beansup/tree/main/technicalTask#первый-вход)
* [Страница тарифов](https://github.com/AndreevAA/beansup/tree/main/technicalTask#страница-тарифов)
* [Страница оплата "Плюс на месяц"](https://github.com/AndreevAA/beansup/tree/main/technicalTask#страница-оплата-плюс-на-месяц)
* [Страница соглашения](https://github.com/AndreevAA/beansup/tree/main/technicalTask#страница-соглашения)
* [Страница политики в области обработки и защиты персональных данных](https://github.com/AndreevAA/beansup/tree/main/technicalTask#страница-политики-в-области-обработки-и-защиты-персональных-данных)
* [Формы заполнения о продукте](https://github.com/AndreevAA/beansup/tree/main/technicalTask#формы-заполнения-о-продукте)
* [Страницы карт](https://github.com/AndreevAA/beansup/tree/main/technicalTask#страницы-карт)
* [Страница установки](https://github.com/AndreevAA/beansup/tree/main/technicalTask#страница-установки)
* [Личный кабинет клиента](https://github.com/AndreevAA/beansup/tree/main/technicalTask#личный-кабинет-клиента)
* [Авторы](#авторы) 
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | Уникальный идентификатор | Строка | - | Да | Уникальный идентификатор пользователя в формате UUID |
| 2 | Логин | Строка | "Введенный адрес почты уже кем-то занят, попробуйте другой адрес."  | Да | Логин совпадает с почтовым адресом |
| 3 | Пароль | Строка | "Введенный пароль очень короткий, это небезопасно." | Да | Больше 8 сиволов, латиница. В БД хранится в закодированном виде |

*Табл. 5 (Дебетовые карты)*
| № | Элемент / поле | Тип | Текст ошибки | Обязательность заполнения | Примечания |
| ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | Уникальный идентификатор | Строка | - | Да | Уникальный идентификатор в формате UUID |
| 2 | Название банка | Строка | - | Да | - |
| 3 | Название карты | Строка | - | Да | - |
| 4 | Обслуживание | Строка | - | Да | - |
| 5 | Условия бесплатности, остаток | Строка | - | Да | - |
| 6 | Смс-уведомления | Строка | - | Да | - |
| 7 | Доставка | Строка | - | Да | - |
| 8 | Пополнение с других карт | Строка | - | Да | - |
| 9 | Процент на остаток | Число | - | Да | - |
| 10 | Максимально в месяц | Число | - | Да | - |
| 11 | В чем выплачивается | Строка | - | Да | - |

Категория - {уйди Карта:процент}

*Табл. 6 (Кредитные карты)*
| № | Элемент / поле | Тип | Текст ошибки | Обязательность заполнения | Примечания |
| ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | Уникальный идентификатор | Строка | - | Да | Уникальный идентификатор пользователя в формате UUID |
| 2 | Логин | Строка | "Пользователь с таким адресом  | Дата | Дата |
| 3 | Пароль | Строка | Дата | Дата | Дата |

*Табл. 7 (Продукты пользователя)*
| № | Элемент / поле | Тип | Текст ошибки | Обязательность заполнения | Примечания |
| ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | Уникальный идентификатор | Строка | - | Да | Уникальный идентификатор пользователя в формате UUID |
| 2 | Идентификатор карты | Строка | "Пользователь с таким адресом  | Дата | Дата |
| 3 | Идентификатор пользователя | Строка | Дата | Дата | Дата |
| 4 | Баланс | Строка | Дата | Дата | Дата |
| 5 | Тип | Строка | Дата | Дата | Дата |
| 6 | Дата выписки | Строка | Дата | Дата | Дата |
| 7 |  | Строка | Дата | Дата | Дата |

*Табл. 8 (Операции)*
| № | Элемент / поле | Тип | Текст ошибки | Обязательность заполнения | Примечания |
| ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | Уникальный идентификатор | Строка | - | Да | Уникальный идентификатор пользователя в формате UUID |
| 2 | Индентификатор продукта пользователя | Строка | "Пользователь с таким адресом  | Дата | Дата |
| 3 | Пароль | Строка | Дата | Дата | Дата |
...
*Табл. 10 (Связка категорий и карты)*
| № | Элемент / поле | Тип | Текст ошибки | Обязательность заполнения | Примечания |
| ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | Уникальный идентификатор | Строка | - | Да | Уникальный идентификатор пользователя в формате UUID |
| 2 | Индентификатор продукта пользователя | Строка | "Пользователь с таким адресом  | Дата | Дата |
...
*Табл. 12 (Информация об обновлениях)*
| № | Элемент / поле | Тип | Текст ошибки | Обязательность заполнения | Примечания |
| ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | Уникальный идентификатор | Строка | - | Да | Уникальный идентификатор пользователя в формате UUID |
| 2 | Индентификатор продукта пользователя | Строка | "Пользователь с таким адресом  | Дата | Дата |
...
*Табл. 14 (Связка категория-карта и МСС-код)*
| № | Элемент / поле | Тип | Текст ошибки | Обязательность заполнения | Примечания |
| ------ | ------ | ------ | ------ | ------ | ------ |
| 1 | Уникальный идентификатор | Строка | - | Да | Уникальный идентификатор пользователя в формате UUID |
| 2 | Индентификатор продукта пользователя | Строка | "Пользователь с таким адресом  | Дата | Дата |
